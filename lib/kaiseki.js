...
Kaiseki.prototype = {
  API_BASE_URL: 'https://cn.avoscloud.com',
  ...
  _jsonRequest: function(opts) {
    ...
    var reqOpts = {
      method: opts.method,
      headers: {
        'X-AVOSCloud-Application-Id': this.applicationId,
        'X-AVOSCloud-Application-Key': this.restAPIKey
      }
    };
    if (this.sessionToken)
      reqOpts.headers['X-AVOSCloud-Session-Token'] = this.sessionToken;
    if (this.masterKey)
      reqOpts.headers['X-AVOSCloud-Master-Key'] = this.masterKey;
    if (opts.headers)
